...
| 28/01/2023 | 0.7 | Quinto dia de desenvolvimento | No dia 5 atualizamos o nome do nó de "Controle" para "HUDJogador; Resetamos os pontos que são deixados pelos inimigos quando o jogador morrer; Agora o jogo possui uma HUD com a imagem de acordo com a arma que está usando; O jogador pode apertar a tecla "F" para pegar as arma que estão no chão; Organização das variáveis. | [Lucas Petruci](https://github.com/LucasPetruci) e [João Capello](https://github.com/Pinais) |
