...
func inicializar(_jogador):
	jogador = _jogador
	jogador.connect("mudar_vida", Callable(self, "atualizar_valor_barra_vida"))
	jogador.connect("mudar_pontuacao", Callable(self, "atualizar_valor_etiqueta_pontuacao"))
	jogador.arma.connect("mudar_qtd_municao", Callable(self, "atualizar_qtd_municao"))
	jogador.connect("mudar_arma_hud", Callable(self, "atualizar_arma_hud"))
	jogador.connect("conectar_arma", Callable(self, "conectar_nova_arma"))
...
func conectar_nova_arma(nova_arma):
	nova_arma.connect("mudar_qtd_municao", Callable(self, "atualizar_qtd_municao"))
...
func atualizar_qtd_municao (_qtd_municao):
	azulejo_municao.size.y = _qtd_municao * tamanho_azulejo_municao.y
